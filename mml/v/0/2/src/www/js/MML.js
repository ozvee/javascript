 ...
 * Creates namespace "MatModLab" and "MML"
 */
MML = MatModLab = {
    ...
    lib: {
        ...
        load_module: function (module_number) {
            ...
            if (!target)
            {
                //If form has allready been loaded
            ...
            function print_header() {
                MML.log('Loaded ' + target.NAME + ' №' + target.ORDER + '. Version: ' + target.VERSION + '. Description: ' + target.DESCRIPTION);
                MML.log('Fill inputs with required values and click "Play" button to run', true);
            }
        ...
        fillSelection: function (select) {
            /*
             * Fills MML lab selection based on MML.modules recognition
             * 
             * @param select: HTML collection object
             */
            select.innerHTML = ('<option value="' + 0 + '">Select module:</option>');
            for (var i = 0; i < MML.modules.length; i++) {
                var module = MML.modules[i];
                select.innerHTML += ('<option value="' + module.ORDER + '">' + module.ORDER + ': ' + module.TITLE + '</option>');
            }
        }
    },
    modules: [
        {
            ...
            VERSION: '0.2.0',
            TITLE: 'Elementary function calculation',
            DESCRIPTION: 'Calculates an elementary function',
            ORDER: 1,
        ...
        },
        {
            NAME: 'MatModLab Framework engine module',
            VERSION: '0.2.0',
            TITLE: 'Horner scheme polynomial evaluation',
        ...
        },
        {
            NAME: 'MatModLab Framework engine module',
            VERSION: '0.2.1',
            TITLE: 'Non-linear equation solving using numerical method',
    ...
    init: function () {
        ...
        window.onload = function () {
            ...
            //Fill lab HTML <select> with available modules
            MML.lib.fillSelection(MML.res.lab_switch);
